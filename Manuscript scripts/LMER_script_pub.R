...
block_df<-read.csv("./Data/block_data.csv")
...
# print table 
write.csv(as.matrix(cover_m0_aov), file = "./Tables/cover_m0.csv", na = "")
write.csv(as.matrix(cover_m0_rand), file = "./Tables/cover_0_rand.csv", na = "")
...
# print table 
write.csv(as.matrix(cover_m1_aov), file = "./Tables/cover_m1.csv", na = "")
write.csv(as.matrix(cover_m1_rand), file = "./Tables/cover_m1_rand.csv", na = "")
...
# print table 
write.csv(as.matrix(cover_m2_aov), file = "./Tables/cover_m2.csv", na = "")
write.csv(as.matrix(cover_m2_rand), file = "./Tables/cover_m2_rand.csv", na = "")
...
# print table 
write.csv(as.matrix(rich_m0_aov), file = "./Tables/rich_m0.csv", na = "")
write.csv(as.matrix(rich_m0_rand), file = "./Tables/rich_m0_rand.csv", na = "")
...
# print table 
write.csv(as.matrix(rich_m1_aov), file = "./Tables/rich_m1.csv", na = "")
write.csv(as.matrix(rich_m1_rand), file = "./Tables/rich_m1_rand.csv", na = "")
...
# print table 
write.csv(as.matrix(rich_m2_aov), file = "./Tables/rich_m2.csv", na = "")
write.csv(as.matrix(rich_m2_rand), file = "./Tables/rich_m2_rand.csv", na = "")
...
# print table 
write.csv(as.matrix(biomass_m0_aov), file = "./Tables/biomass_m0.csv", na = "")
write.csv(as.matrix(biomass_m0_rand), file = "./Tables/biomass_m0_rand.csv", na = "")
...
# print table 
write.csv(as.matrix(biomass_m1_aov), file = "./Tables/biomass_m1.csv", na = "")
write.csv(as.matrix(biomass_m1_rand), file = "./Tables/biomass_m1_rand.csv", na = "")
...
# print table 
write.csv(as.matrix(biomass_m2_aov), file = "./Tables/biomass_m2.csv", na = "")
write.csv(as.matrix(biomass_m2_rand), file = "./Tables/biomass_m2_rand.csv", na = "")
...
html2pdf(filename = "~/herbivory_asynchrony/Tables/m2_table.html", 
         table_width = 13, 
         silent = TRUE, 
         style = TRUE, 
         build_pdf = TRUE, 
...
# this is for checking
check_collinearity(rich_lmer_m1)
